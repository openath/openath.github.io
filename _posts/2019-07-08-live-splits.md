...
<div class="row">
	<div class="col-md-6">
		<figure>
			...
			<figcaption>Kilometer to go...</figcaption>
		</figure>
	</div>
	<div class="col-md-6">
		<figure>
			<img src="/assets/img/screenshots/twell.png" class="screen" width="100%">
			<figcaption>As Steph crossed the line...</figcaption>
		</figure>
	</div>
</div>

If you want to see the effect, browse to one of the races now, go to the fourth tab "Re-Play", and hit Play.  It should work on all sizes.
